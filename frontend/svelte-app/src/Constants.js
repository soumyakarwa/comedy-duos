...
export const episodeBreakdownText = [
  ...
  `Then, I compared the three descriptions to ensure a character group existed independently in each. For instance, all three descriptions contain a distinct plot point describing <span class="highlighted" style="background-color: rgb(82, 180, 255, 0.7); color: var(--black)">Jake and Captain Holt’s</span> secret case!`,
  `Here's where it gets interesting. I compared all the descriptions to correspond and break up larger character groups. Comparing the plot points and sentence structure of the<span class="italic">Official Description</span> and the <span class="italic">Wikipedia Description</span> against the<span class="italic">Wikifandom Description</span> helped confirm another pair: <span class="highlighted" style="background-color: rgb(142, 208, 0, 0.7); color: var(--black)">Rosa, Amy</span> while they were planning The Vulture’s party (ew)!`,
  `Last but not least, we have <span class="highlighted" style="background-color: rgb(163, 102, 255, 0.7); color: var(--black)">Charles and Terry</span>! Using this method, I identified the groupings in "The Oolong Slayer" and subsequently for all 153 episodes.`,
];
